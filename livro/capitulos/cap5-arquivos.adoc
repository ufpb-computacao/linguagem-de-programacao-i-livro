...
strings são escritos e representados em C:
...
ponto de leitura ou escrita do arquivo, as seguintes funções servem a
este propósito:

==== Retrocede para o início do arquivo com rewind

O seguinte função retrocede o indicador de posição para o início do
arquivo:
...
Para ir para o final do arquivo invocamos:
