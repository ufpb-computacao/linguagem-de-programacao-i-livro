...
receber um `FILE*` ao invés de um `char*` que seria o nome do arquivo,
diferente de como fizemos com a função `lerConteudoDoArquivo`
(<<src_primeiro_teste>>). Isto foi intencional, pois pretendemos, no
