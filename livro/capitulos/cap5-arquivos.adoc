...
Decidimos criar a função `criaArquivoTemporario` apenas para aumentar
a legibilidade do código para os leitores em português. Na prática,
não haveria a necessidade de criá-la.
