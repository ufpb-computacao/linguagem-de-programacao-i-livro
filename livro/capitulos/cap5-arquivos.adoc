...
aberto deve ser fechado após sua utilização.

Para fecha um arquivo utilizamos a função <<fclose>>, passando como
parâmetro o ponteiro `FILE*` retornado na abertura do arquivo:
