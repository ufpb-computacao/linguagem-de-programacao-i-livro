...
carácter `\`. Já no Unix, existe um único diretório raiz `/` onde
todos os demais diretórios são _descendentes_ dele, o carácter
separador de diretório é o `/`, diferente do Windows.
