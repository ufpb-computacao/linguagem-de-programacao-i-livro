...
==== Escrevendo uma linha com fputs

A função <<fputs>> escreve um buffer (string terminado com o carácter
zero) no arquivo.

----
int fputs(const char * restrict buffer, FILE * restrict arquivo);
----
