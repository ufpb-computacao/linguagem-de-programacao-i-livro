...
Nós poderíamos ter adicionado neste função a lógica de verificar se o 
carácter é uma vogal, e só invocar a tradução nestes casos. No
...
.Testes falhando apesar da nossa implementação
....
$ make clean && make lingua-do-i-test && ./lingua-do-i-test
rm -rf lingua-do-i lingua-do-i-test
gcc -Wall -g -std=c1x lingua-do-i-test.c lingua-do-i-core.c -o lingua-do-i-test
...
é extremamente simples, ele deveria passar! Nestes casos, somente a
*depuração* do programa para encontrar o erro, é exatamente o que
