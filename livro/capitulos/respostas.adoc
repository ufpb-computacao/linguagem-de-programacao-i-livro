...
TIP: Na sala de aula, nos fóruns e mensagens recomendamos a utilização
do site https://gist.github.com para compartilhar códigos e tirar
dúvidas sobre eles.

=== Capítulo 1


4:: O programa precisa ler um CPF, salvá-lo numa variável do tipo
`long long` e em seguida imprimir seu conteúdo.
+
--
.Código fonte
{gitrepo}/blob/{edition}/livro/capitulos/code/cap1/cpf_formatado.c[code/cap1/cpf_formatado.c]

[source, c]
----
include::code/cap1/cpf_formatado.c[]
----

.Saída da execução
....
include::code/cap1/cpf_formatado.out[]
....
...
.Código fonte
{gitrepo}/blob/{edition}/livro/capitulos/code/respostas/reg_compromisso.c[code/respostas/reg_compromisso.c]
