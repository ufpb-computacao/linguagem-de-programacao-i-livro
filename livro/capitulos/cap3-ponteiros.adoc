...
.Código fonte
{gitrepo}/blob/master/livro/capitulos/code/cap3/subtracao-passagem-por-valor.c[code/cap3/subtracao-passagem-por-valor.c]

[source, c]
----
include::code/cap3/subtracao-passagem-por-valor.c[]
----
...
.Código fonte
{gitrepo}/blob/master/livro/capitulos/code/cap3/passagem_incorreta.c[code/cap3/passagem_incorreta.c]

[source, c]
.Titulo do código
----
include::code/cap3/passagem_incorreta.c[]
----

.Execução da aplicação
....
include::code/cap3/passagem_incorreta.out[]
....
...
.Código fonte
{gitrepo}/blob/master/livro/capitulos/code/cap3/passagem_por_referencia.c[code/cap3/passagem_por_referencia.c]

[source, c]
----
include::code/cap3/passagem_por_referencia.c[]
----
...
.Execução da aplicação
....
include::code/cap3/passagem_por_referencia.out[]
....
