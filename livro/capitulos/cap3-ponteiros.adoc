...
NOTE: Na <<fig_inicializacao_ponteiro>>(a) é demonstrada uma forma
...
.Código fonte
{gitrepo}/blob/master/livro/capitulos/code/cap3/usando_ponteiro.c[code/cap3/usando_ponteiro.c]

[source, c]
.Usado ponteiro para alterar variável
----
include::code/cap3/usando_ponteiro.c[]
----

.Resultado da execução
....
include::code/cap3/usando_ponteiro.out[]
....
